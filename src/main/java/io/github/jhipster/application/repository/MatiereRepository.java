...
public interface MatiereRepository extends JpaRepository<Matiere, Long> {
    ...
    @Query(value = "select distinct matiere from Matiere matiere left join fetch matiere.formateurs left join fetch matiere.stagiaires left join fetch matiere.modules",
    ...
    @Query("select matiere from Matiere matiere left join fetch matiere.formateurs left join fetch matiere.stagiaires left join fetch matiere.modules where matiere.id =:id")
