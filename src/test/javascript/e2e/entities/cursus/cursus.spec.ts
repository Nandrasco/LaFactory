...
describe('Cursus e2e test', () => {
    ...
    it('should load Cursuses', async () => {
        ...
        expect(await cursusComponentsPage.getTitle()).to.eq('laFactoryApp.cursus.home.title');
    });
    ...
    it('should load create Cursus page', async () => {
        ...
        expect(await cursusUpdatePage.getPageTitle()).to.eq('laFactoryApp.cursus.home.createOrEditLabel');
    ...
    it('should delete last Cursus', async () => {
        ...
        expect(await cursusDeleteDialog.getDialogTitle()).to.eq('laFactoryApp.cursus.delete.question');
