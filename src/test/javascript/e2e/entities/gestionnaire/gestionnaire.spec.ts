...
describe('Gestionnaire e2e test', () => {
    ...
    it('should load Gestionnaires', async () => {
        ...
        expect(await gestionnaireComponentsPage.getTitle()).to.eq('laFactoryApp.gestionnaire.home.title');
    });
    ...
    it('should load create Gestionnaire page', async () => {
        ...
        expect(await gestionnaireUpdatePage.getPageTitle()).to.eq('laFactoryApp.gestionnaire.home.createOrEditLabel');
    ...
    it('should delete last Gestionnaire', async () => {
        ...
        expect(await gestionnaireDeleteDialog.getDialogTitle()).to.eq('laFactoryApp.gestionnaire.delete.question');
