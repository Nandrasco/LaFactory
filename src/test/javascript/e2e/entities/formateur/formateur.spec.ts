...
describe('Formateur e2e test', () => {
    ...
    it('should load Formateurs', async () => {
        ...
        expect(await formateurComponentsPage.getTitle()).to.eq('laFactoryApp.formateur.home.title');
    });
    ...
    it('should load create Formateur page', async () => {
        ...
        expect(await formateurUpdatePage.getPageTitle()).to.eq('laFactoryApp.formateur.home.createOrEditLabel');
    ...
    it('should delete last Formateur', async () => {
        ...
        expect(await formateurDeleteDialog.getDialogTitle()).to.eq('laFactoryApp.formateur.delete.question');
