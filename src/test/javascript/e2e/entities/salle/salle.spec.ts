...
describe('Salle e2e test', () => {
    ...
    it('should load Salles', async () => {
        ...
        expect(await salleComponentsPage.getTitle()).to.eq('laFactoryApp.salle.home.title');
    });

    it('should load create Salle page', async () => {
        await salleComponentsPage.clickOnCreateButton();
        salleUpdatePage = new SalleUpdatePage();
        expect(await salleUpdatePage.getPageTitle()).to.eq('laFactoryApp.salle.home.createOrEditLabel');
    ...
    it('should delete last Salle', async () => {
        ...
        expect(await salleDeleteDialog.getDialogTitle()).to.eq('laFactoryApp.salle.delete.question');
