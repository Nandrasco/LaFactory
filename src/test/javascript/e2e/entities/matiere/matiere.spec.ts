...
describe('Matiere e2e test', () => {
    ...
    it('should load Matieres', async () => {
        ...
        expect(await matiereComponentsPage.getTitle()).to.eq('laFactoryApp.matiere.home.title');
    });
    ...
    it('should load create Matiere page', async () => {
        ...
        expect(await matiereUpdatePage.getPageTitle()).to.eq('laFactoryApp.matiere.home.createOrEditLabel');
    ...
    it('should delete last Matiere', async () => {
        ...
        expect(await matiereDeleteDialog.getDialogTitle()).to.eq('laFactoryApp.matiere.delete.question');
