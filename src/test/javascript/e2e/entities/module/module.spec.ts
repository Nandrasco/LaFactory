...
describe('Module e2e test', () => {
    ...
    it('should load Modules', async () => {
        ...
        expect(await moduleComponentsPage.getTitle()).to.eq('laFactoryApp.module.home.title');
    });
    ...
    it('should load create Module page', async () => {
        ...
        expect(await moduleUpdatePage.getPageTitle()).to.eq('laFactoryApp.module.home.createOrEditLabel');
    ...
    it('should delete last Module', async () => {
        ...
        expect(await moduleDeleteDialog.getDialogTitle()).to.eq('laFactoryApp.module.delete.question');
