...
describe('Ordinateur e2e test', () => {
    ...
    it('should load Ordinateurs', async () => {
        ...
        expect(await ordinateurComponentsPage.getTitle()).to.eq('laFactoryApp.ordinateur.home.title');
    });
    ...
    it('should load create Ordinateur page', async () => {
        ...
        expect(await ordinateurUpdatePage.getPageTitle()).to.eq('laFactoryApp.ordinateur.home.createOrEditLabel');
    ...
    it('should delete last Ordinateur', async () => {
        ...
        expect(await ordinateurDeleteDialog.getDialogTitle()).to.eq('laFactoryApp.ordinateur.delete.question');
